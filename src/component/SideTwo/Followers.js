        ...
        <Box sx={{ }}>
            ...
            <div style={{ display:'flex', background: 'white', justifyContent: 'space-between'}}>
                <div style={{display: 'flex', alignContent: 'center', padding: '1rem 2rem', cursor: 'pointer'}}>
                    <img src={follower.profilepics.url} style={{width: '50px', height: '50px', borderRadius: '50%'}} />
                    <div style={{display: 'flex', flexDirection: 'column', paddingLeft: '1rem'}}>
                        <Typography variant='h5'><b>{follower.name} </b></Typography>
                        <Typography variant='h7'>{follower.bio}</Typography>
                    </div>
                </div>
